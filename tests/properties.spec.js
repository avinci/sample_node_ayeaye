...
describe('/properties route', function () {
  describe('GET /properties', function () {

    it('should include server ip and datetime by default', function (done) {
      request(app)
        .get('/properties')
  ...
  describe('POST /properties', function () {
    it('should ignore properties with empty keys or values', function (done) {
      request(app)
        .post('/properties')
        .send({
          key: 'iHaveNoValue',
    ...
    it('should add new or update existing properties', function (done) {
      request(app)
        .post('/properties')
        .send({
          key: 'myKey',
